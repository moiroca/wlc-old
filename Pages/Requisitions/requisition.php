                            ...
                            <ul>
                                <li>
                                    <p>
                                        <b>Name: </b> 
                                        <?php
                                            $user = $userObj->getAll(['*'], ['id' => $requisition['requisition_department_head_id']])->fetch_assoc();
                                        ?>
                                        <?php if (!is_null($user)) { ?>
                                ...
                                <li>
                                    <p>
                                        ...
                                        <?php if (!is_null($requisition['requisition_department_head_id']) && $requisition['requisition_department_head_id'] == Constant::REQUISITION_APPROVED ): ?>
                                            <?php echo $requisition['requisition_datetime_approveddeclined_by_department_head']; ?>
                                        <?php else: ?>
                                            <label class='label label-info'>Not Available</label>
                                        <?php endif ?>
                                    </p>
                                ...
                                <li>
                                    <p>
                                        ...
                                        <?php if (!is_null($requisition['requisition_department_head_id']) && $requisition['requisition_status'] == Constant::REQUISITION_DECLINED ): ?>
                                            <?php echo $requisition['requisition_datetime_approveddeclined_by_department_head']; ?>
                                        <?php else: ?>
                                            <label class='label label-info'>Not Available</label>
                                        <?php endif; ?>
                            ...
                            <ul>
                                <li>
                                    <p>
                                        <b>Name: </b> 
                                        <?php
                                            $user = $userObj->getAll(['*'], ['id' => $requisition['requisition_comptroller_id']])->fetch_assoc();
                                        ?>
                                        <?php if (!is_null($user)) { ?>
                                            <?php echo $user['lastname'].', '.$user['firstname']; ?>
                                        <?php } else { ?>
                                ...
                                <li>
                                    <p>
                                        <b>Approved Datetime: </b> 
                                        <?php if (!is_null($requisition['requisition_comptroller_id']) && $requisition['requisition_status'] == Constant::REQUISITION_APPROVED ): ?>
                                            <?php echo $requisition['requisition_datetime_approveddeclined_by_comptroller']; ?>
                                        <?php else: ?>
                                            <label class='label label-info'>Not Available</label>
                                        <?php endif ?>
                                    </p>
                                ...
                                <li>
                                    <p>
                                        <b>Declined Datetime: </b> 
                                        <?php if (!is_null($requisition['requisition_comptroller_id']) && $requisition['requisition_status'] == Constant::REQUISITION_DECLINED ): ?>
                                            <?php echo $requisition['requisition_datetime_approveddeclined_by_comptroller']; ?>
                                        <?php else: ?>
                                            <label class='label label-info'>Not Available</label>
                                        <?php endif; ?>
