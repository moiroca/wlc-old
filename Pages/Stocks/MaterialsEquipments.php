    ...
    <div class="col-md-12">
      <div class="table-responsive">
        ...
        <?php 
            ...
            $result = $stocks->getAllByType(Constant::ITEM_MATERIAL_EQUIPMENT);
        ?>
            ...
            <?php if ($result && 0 != $result->num_rows) { ?>
                ...
                <?php  while ($item = $result->fetch_assoc()) { ?>
                  <tr>
                    ...
                    <td> 
                      <a type="button" class="btn btn-info btn-sm" href='<?php echo Link::createUrl('Pages/Stocks/listing.php?name='.urlencode($item['stock_name']).'&type='.Constant::ITEM_MATERIAL_EQUIPMENT); ?>'> View All <b><?php echo ucfirst($item['stock_name']); ?></b></a> 
                    </td>
                  </tr>  
                <?php $number++; ?>
                <?php } ?>
