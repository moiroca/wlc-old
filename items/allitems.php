                ...
                <table class="table table-striped table-hover table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php
                      $query_area = mysql_query("SELECT * FROM area_dept where area_id ='".$_SESSION['area_id']."'");
                      if(mysql_num_rows($query_area) > 0){
                       while($qArea = mysql_fetch_array($query_area)){
                      ?>
                      <td> <?php echo $qArea['area_name']; ?></td>
                      <?php }
                      }
                      ?>
