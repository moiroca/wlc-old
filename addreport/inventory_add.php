            ...
            <div class="col-md-12">
              <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered">
                  <thead>
                  <form name="addInventory" method="post" action="requisition_add.php">
                    ...
                    --><h5 style="color:red;">*Only QUANTITY and REMARKS can be EDITED. And Please add a purpose of your request.<br> &nbsp;&nbsp;Please Review before SAVING.</h5>                      <?php
                  ...
                  <tbody>
                    ...
                    while($row = mysql_fetch_array($result)){
                      $_SESSION['origQuantity']=$row['item_quantity'];
                    ?>
                    <tr>
                      <td><input style="width:80px;" type='readonly' name ='item_id[]' value= '<?php echo $row['item_id'] ; ?> ' readonly></td>
                      ...
                      <td> <input style="width:80px;" type='text' name ='item_quantity[]' value= '<?php echo $row['item_quantity'] ; ?> '></td>
                      <td> <select name="item_status[]">
                        <option name="good" value="Good Condition">Good Condition</option>
                        <option name="repair" value="For Repair">For Repair</option>
                      </select></td>
                      <td> <input type='text' name ='item_purpose[]' value= '<?php echo $row['item_purpose'] ; ?> '></td>
                    </tr>           
                    <?php
                        }
                        echo "</table>";  
