                     ...
                     <?php 
                        ...
                        // Check if delete button active, start this 
                          ...
                          if(isset($_POST['delete']))
                          {
                            ...
                            {
                              mysql_query("Delete from itemstatus where status_id = '".$checkbox[$i]."'") or die ("Error");
                            }
                              echo "<meta http-equiv=\"refresh\" content=\"0;URL=status_view.php\">";
                          }
                          
                          if(isset($_POST['add']))
                          {
                            echo "<meta http-equiv=\"refresh\" content=\"0;URL=status_add.php\">";
                          }
