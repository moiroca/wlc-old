      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Update Availability</li>
          </ol>
              ...
              <div class="table-responsive" >
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">Update Availability</h4>
                  </div>
    ...
    mysql_select_db("inventory");
            ...
            if(isset($_POST['update']))
            {
                ...
                $checkbox = $_POST['checkbox'];
                    ...
                    {
                    $result=mysql_query("Select * from Availability where avail_id='".$checkbox[$i]."'") or die ("Error in Query");
                        
                        if(mysql_num_rows($result)>0)
                        {
                            while($row =  mysql_fetch_array($result))
                            
                            { $_SESSION['avail_id'] = $row['avail_id'];
    
?> 
            <fieldset>
                <form action = "process_availupdate.php" method="post">
                    
                    <p><label for="status_avail">Description:</label>
                    <input name="status_avail" id="status_avail" type="text" value="<?php echo $row['status_avail'];?>" placeholder="Description" required="required"/></p>
