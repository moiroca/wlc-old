    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          $id_avail=$_SESSION['avail_id'];
					$stat_avail=$_POST['status_avail'];

						
						
            $que = "Select * from Availability where status_avail='".$stat_avail."'";
            $res = mysql_query($que) or die("YEHET");
            if(mysql_num_rows($res)){
						echo"<script>
							alert('Already Exist.');
							</script>
							<meta http-equiv='refresh' content='0;url= avail_update.php'>";
						}
            else{
              mysql_query("Update Availability SET status_avail='".$stat_avail."' where avail_id='".$id_avail."' ");
