...
<body>
  <div id="main-wrapper">
    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            <li><a href="avail_add.php">Add Status Availability</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered">
                  <thead>
                    <form name="actionAvail" method="post" action="">
                      <?php
                              
                                $result = mysql_query("SELECT * FROM Availability ");
            ...
            <?php while($row = mysql_fetch_array($result))
                {
            ?>      <tr>
                        <td> <input type='checkbox' name ='checkbox[]' value= '<?php echo $row['avail_id']; ?> '></td>
                        <td > <?php echo $row['avail_id']; ?></td>
                        <td><?php echo $row['status_avail'] ?></td>
                  </tr>           
            <?php
                }
                echo "</table>";  
    ...
    echo"<input type='submit' name='update' value='Update' class='butt' onclick='setUpdateActionAvail();'>";
    echo"<input type='submit' name='delete' value='Delete' class='butt' onClick='setDeleteActionAvail();'>";
    ?>                
                  </tbody>
                </table>
              </div>
