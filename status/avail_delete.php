    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            <li><a href="item_view.php">Manage Item Status</a></li>
            <li class="active">Delete Type of Status</li>
          </ol>
              ...
              <div class="table-responsive" >
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">Delete Item Status</h4>
                  </div>
                     ...
                     <?php 
                        ...
                        // Check if delete button active, start this 
                          ...
                          if(isset($_POST['delete']))
                          {
                            ...
                            {
                              mysql_query("Delete from Availability where avail_id = '".$checkbox[$i]."'") or die ("Error");
                            }
                              echo "<meta http-equiv=\"refresh\" content=\"0;URL=status_availview.php\">";
                          }
                          
                          if(isset($_POST['add']))
                          {
                            echo "<meta http-equiv=\"refresh\" content=\"0;URL=avail_add.php\">";
                          }
