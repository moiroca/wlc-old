              ...
              <div class="table-responsive">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <fieldset>
                        <form action = "groupitem_add.php" method="post">
                            <p><label for="item_id">Item ID:</label>
                            <input name="item_id" id="item_id" type="item_id" placeholder="item ID" required="required"/></p>
                            <p>Area/Department: 
                            <select name='area_id'>
                            <?php 
                            ...
                            <input name="item_area" id="item_area" type="text" placeholder="Area" required="required"/></p>
